...
public class KnoteController {
	...
	public ResponseEntity<HttpStatusCode> saveNotes(@RequestParam("image") MultipartFile file,
			@RequestParam String description, @RequestParam(required = false) String publish,
			@RequestParam(required = false) String upload, Model model) throws Exception {
		...
		if (upload != null && upload.equals("Upload")) {
			...
			// responseDescription[0]=("image: "+file.getOriginalFilename()+" is
